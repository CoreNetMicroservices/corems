...
- [ ] 4. Infrastructure layer — EF Core DbContext, configurations, and repositories
  ...
  - [x] 4.3 Create initial EF Core migration matching existing PostgreSQL schema
  ...
  - [x] 4.5 Write property tests for data uniqueness constraints
...
- [x] 6. Configuration, validation, and error handling
  - [x] 6.1 Create strongly-typed Options classes and appsettings.json
  ...
  - [x] 6.2 Implement FluentValidation validators
  ...
  - [x] 6.3 Implement GlobalExceptionHandler (IExceptionHandler)
  ...
  - [x] 6.4 Write property tests for password validation and exception mapping
...
- [x] 7. Domain services — AuthService, UserService, TokenService
  - [x] 7.1 Implement UserService
...
- [x] 9. OpenIddict configuration and OAuth2 controllers
  - [x] 9.1 Configure OpenIddict in Program.cs
  ...
  - [x] 9.2 Implement AuthorizationController (OpenIddict endpoints)
  ...
  - [x] 9.3 Write property tests for OAuth2 flows
...
- [x] 10. API controllers, authentication, and middleware pipeline
  - [x] 10.1 Implement AuthController (signup, verify-email, verify-phone, resend-verification, forgot-password, reset-password)
  ...
  - [x] 10.2 Implement ProfileController (update-profile, change-password)
    - Require [Authorize] attribute
    - Use ICurrentUserService to resolve caller UUID
    - _Requirements: 7.4, 7.5, 8.1, 8.2, 8.3_

  - [x] 10.3 Implement UsersController (admin CRUD, change-password, change-email)
  ...
  - [x] 10.4 Configure Program.cs middleware pipeline and DI registration
  ...
  - [x] 10.5 Write property test for admin authorization gate
...
- [x] 11. Background services and token cleanup
  - [x] 11.1 Implement TokenCleanupService (BackgroundService)
  ...
  - [x] 11.2 Write property test for token cleanup
